...
hints:
  DockerRequirement:
    # there is a bug in the biobb_amber package. the order of solvatebox arguments are not correct
    # https://ambermd.org/tutorials/advanced/tutorial2/section1.htm
    dockerPull: ndonyapour/biobb_amber #quay.io/biocontainers/biobb_amber:3.7.1--pyhdfd78af_0
